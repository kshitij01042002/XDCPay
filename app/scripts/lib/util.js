...
/**
 * Checks whether a given balance of XDC, represented as a hex string, is sufficient to pay a value plus a gas fee
 *
 ...
 * @param {string} txParams.value The value of XDC to send
 * @param {string} hexBalance - A balance of XDC represented as a hex string
