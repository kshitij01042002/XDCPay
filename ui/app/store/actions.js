...
export function updateAndSetCustomRpc (newRpc, chainId, ticker = 'XDC', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function editRpc (oldRpc, newRpc, chainId, ticker = 'XDC', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function setRpcTarget (newRpc, chainId, ticker = 'XDC', nickname) {
  return async (dispatch) => {
