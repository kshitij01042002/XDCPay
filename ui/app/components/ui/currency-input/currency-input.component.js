 ...
 * gets converted into a decimal value depending on the currency (XDC or Fiat).
 */
export default class CurrencyInput extends PureComponent {
  ...
  getDecimalValue (props) {
    ...
    const decimalValueString = this.shouldUseFiat()
      ...
      : getValueFromWeiHex({
        value: hexValue, toCurrency: XDC, numberOfDecimals: 6,
      })
  ...
  handleChange = (decimalValue) => {
    ...
    const hexValue = this.shouldUseFiat()
      ...
      : getWeiHexFromDecimalValue({
        value: decimalValue, fromCurrency: XDC, fromDenomination: XDC, conversionRate,
      })
